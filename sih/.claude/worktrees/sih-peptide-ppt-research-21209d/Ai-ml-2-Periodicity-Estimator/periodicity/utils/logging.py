...
Deliberately identical to Ai-ml-1's copy. The two services are separately deployable and share
no code, but they must produce the same log shape or correlating a single simulation across the
hop means reconciling two formats by hand.
"""
